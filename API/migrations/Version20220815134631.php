 ...
 */
final class Version20220815134631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP code_cart, DROP test, CHANGE price price NUMERIC(5, 2) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD code_cart INT NOT NULL, ADD test VARCHAR(255) NOT NULL, CHANGE price price NUMERIC(2, 2) NOT NULL');
    }
}
