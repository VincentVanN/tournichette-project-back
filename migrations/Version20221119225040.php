 ...
 */
final class Version20221119225040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(20) NOT NULL, slug VARCHAR(255) DEFAULT NULL, image VARCHAR(100) DEFAULT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE depot (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, address VARCHAR(100) NOT NULL, informations VARCHAR(255) DEFAULT NULL, available TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, depot_id INT NOT NULL, user_id INT DEFAULT NULL, ordered_at DATETIME NOT NULL, price NUMERIC(7, 2) NOT NULL, payment_status VARCHAR(5) NOT NULL, deliver_status VARCHAR(5) NOT NULL, paid_at DATETIME DEFAULT NULL, delivered_at DATETIME DEFAULT NULL, payment_id VARCHAR(255) DEFAULT NULL, INDEX IDX_F52993988510D4DE (depot_id), INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, product_id INT DEFAULT NULL, name VARCHAR(64) NOT NULL, slug VARCHAR(255) DEFAULT NULL, stock NUMERIC(10, 0) DEFAULT NULL, unity VARCHAR(20) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, price NUMERIC(7, 2) NOT NULL, description LONGTEXT DEFAULT NULL, colorimetry VARCHAR(20) DEFAULT NULL, archived TINYINT(1) NOT NULL, quantity_unity INT DEFAULT 1 NOT NULL, on_sale TINYINT(1) NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), UNIQUE INDEX UNIQ_D34A04AD4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sales_status (id INT AUTO_INCREMENT NOT NULL, enable TINYINT(1) NOT NULL, start_at DATETIME DEFAULT NULL, start_mail LONGTEXT DEFAULT NULL, start_mail_subject VARCHAR(255) DEFAULT NULL, end_mail LONGTEXT DEFAULT NULL, send_mail TINYINT(1) NOT NULL, end_mail_subject VARCHAR(255) DEFAULT NULL, end_at DATETIME DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, email_checked TINYINT(1) NOT NULL, email_notifications TINYINT(1) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, stripe_customer_id VARCHAR(255) DEFAULT NULL, api_token VARCHAR(255) DEFAULT NULL, api_token_updated_at DATETIME DEFAULT NULL, email_token VARCHAR(255) DEFAULT NULL, email_token_updated_at DATETIME DEFAULT NULL, temp_token VARCHAR(255) DEFAULT NULL, temp_token_updated_at DATETIME DEFAULT NULL, temp_api_token VARCHAR(255) DEFAULT NULL, sub VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
